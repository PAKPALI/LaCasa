...
<head>
    <meta charset="UTF-8">
    <title>Rapport Hebdomadaire - Statistiques Utilisateurs</title>
</head>
                ...
                <table align="center" cellpadding="0" cellspacing="0" width="600" 
                    ...
                    <tr>
                        <td style="background-color:#0a5275; padding:20px; text-align:center;">
                            <h2 style="color:white; margin:0;">📊 Rapport Hebdomadaire - Utilisateurs</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 25px; color:#333;">
                            ...
                            <p style="font-size:15px; line-height:1.6;">
                                Voici les statistiques des utilisateurs pour la semaine :
                            </p>
                            ...
                            <table width="100%" cellpadding="8" cellspacing="0"
                                ...
                                <tr>
                                    <td><strong>Semaine actuelle :</strong></td>
                                    <td>{{ $stats['period']['current'] }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Semaine précédente :</strong></td>
                                    <td>{{ $stats['period']['previous'] }}</td>
                                </tr>
                            </table>

                            <!-- Stats actuelles -->
                            <h3 style="color:#0a5275;">Statistiques semaine actuelle</h3>
                            <table width="100%" cellpadding="8" cellspacing="0"
                                   style="background:#eef9ff; border-radius:6px;">
                                <tr>
                                    <td><strong>Total utilisateurs :</strong></td>
                                    <td>{{ $stats['current_week']['total_users'] }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Total agences :</strong></td>
                                    <td>{{ $stats['current_week']['total_agency'] }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Total clients / personnes :</strong></td>
                                    <td>{{ $stats['current_week']['total_clients'] }}</td>
                                </tr>
                            </table>

                            <!-- Stats semaine précédente -->
                            <h3 style="color:#0a5275;">Comparaison avec la semaine précédente</h3>
                            <table width="100%" cellpadding="8" cellspacing="0"
