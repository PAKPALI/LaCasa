                ...
                <table align="center" cellpadding="0" cellspacing="0" width="600" 
                    ...
                    <tr>
                        <td style="background-color:#0a5275; padding:20px; text-align:center;">
                            <h2 style="color:white; margin:0;">Nouvel utilisateur enregistré</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 25px; color:#333;">
                            ...
                            <p style="font-size:15px; line-height:1.6;">
                                Un nouvel utilisateur vient de s’inscrire sur <strong>LaCasa</strong>.
                            ...
                            <p style="margin-top:20px; font-size:15px; line-height:1.6;">
                                Connectez-vous a la partie admin pour consulter plus de détails.
                            </p>
