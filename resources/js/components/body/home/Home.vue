          ...
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              ...
              <ul class="property-specs-wrap mb-3 mb-lg-0">
                <li><span class="property-specs">Beds</span><span class="property-specs-number">2 <sup>+</sup></span></li>
                <li><span class="property-specs">Baths</span><span class="property-specs-number">2</span></li>
                <li><span class="property-specs">SQ FT</span><span class="property-specs-number">7,000</span></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              ...
              <ul class="property-specs-wrap mb-3 mb-lg-0">
                <li><span class="property-specs">Beds</span><span class="property-specs-number">2 <sup>+</sup></span></li>
                <li><span class="property-specs">Baths</span><span class="property-specs-number">2</span></li>
                <li><span class="property-specs">SQ FT</span><span class="property-specs-number">1,620</span></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="property-entry h-100">
            ...
            <div class="p-4 property-body">
              ...
              <ul class="property-specs-wrap mb-3 mb-lg-0">
                <li><span class="property-specs">Beds</span><span class="property-specs-number">2 <sup>+</sup></span></li>
                <li><span class="property-specs">Baths</span><span class="property-specs-number">2</span></li>
                <li><span class="property-specs">SQ FT</span><span class="property-specs-number">5,500</span></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
          <a href="#"><img :src="img4" alt="Image" class="img-fluid" /></a>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img :src="person1" alt="Image" class="img-fluid rounded mb-4" />
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img :src="person2" alt="Image" class="img-fluid rounded mb-4" />
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img :src="person3" alt="Image" class="img-fluid rounded mb-4" />

            <div class="text">

              <h2 class="mb-2 font-weight-light text-black h4">Sadi Green</h2>
              <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum quam voluptates quod eligendi itaque esse autem repellat a ullam, dolores aspernatur expedita doloribus, veniam cumque quisquam necessitatibus pariatur voluptatum!</p>
              <p>
                <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
                <a href="#" class="text-black p-2"><span class="icon-twitter"></span></a>
                <a href="#" class="text-black p-2"><span class="icon-linkedin"></span></a>
        ...
        <div class="col-md-12 block-13">
          <div class="owl-carousel nonloop-block-13">
            <blockquote class="testimonial">
              <img :src="person1" alt="Image" class="img-fluid mb-4 rounded-circle" />
              <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem ipsam nihil assumenda dolores nostrum quo vero neque vitae rerum sunt similique eveniet cumque quod nemo hic exercitationem. Reiciendis, vel nostrum!&rdquo;</p>
              <p><em>&mdash; Jean Smith</em></p>
            </blockquote>
            <blockquote class="testimonial">
              <img :src="person2" alt="Image" class="img-fluid mb-4 rounded-circle" />
              <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem ipsam nihil assumenda dolores nostrum quo vero neque vitae rerum sunt similique eveniet cumque quod nemo hic exercitationem. Reiciendis, vel nostrum!&rdquo;</p>
              <p><em>&mdash; John Doe</em></p>
            </blockquote>
            <blockquote class="testimonial">
              <img :src="person3" alt="Image" class="img-fluid mb-4 rounded-circle" />
              <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem ipsam nihil assumenda dolores nostrum quo vero neque vitae rerum sunt similique eveniet cumque quod nemo hic exercitationem. Reiciendis, vel nostrum!&rdquo;</p>
              <p><em>&mdash; Mike Johnson</em></p>
            </blockquote>
          </div>
        </div>
      </div>
