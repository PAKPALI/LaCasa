        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button class="btn btn-dark" @click="saveCountry" :disabled="!isFormValid">Ajouter</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade mt-5" id="updatedCountryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-light">
                    <button class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                    <button class="btn btn-warning" @click="updateCountry" :disabled="!isFormValid">Modifier</button>
                </div>
            </div>
        </div>
    </div>
...
// filtred countryies based on search query
