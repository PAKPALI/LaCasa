<template>
  ...
  <div class="accordion-item mb-4">
    <h2 class="accordion-header" id="headingPubType">
      <button class="accordion-button bg-primary text-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePubType" aria-expanded="true" aria-controls="collapsePubType">
        SECTION TYPES DE PUB
      </button>
    </h2>
    <div id="collapsePubType" class="accordion-collapse collapse show" aria-labelledby="headingPubType" data-bs-parent="#accordionExample">
      <div class="accordion-body bg-dark text-white">
        ...
        <!-- Search -->
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Rechercher un type ou une catégorie..." v-model="searchQuery">
        </div>
          ...
          <tbody>
            <tr v-for="(pubType, index) in paginatedPubTypes" :key="pubType.id">
              ...
              <td>
                ...
                <button class="btn btn-sm btn-warning me-1" @click="pubTypeUpdated(pubType)" :disabled="loadingButton==='update'">
                  <span v-if="loadingButton==='update'" class="spinner-border spinner-border-sm text-dark"></span>
                  <span v-if="loadingButton!=='update'"><i class="bi bi-pencil-square"></i></span>
                </button>
                <button class="btn btn-sm btn-danger" @click="deletedPubType(pubType.id)" :disabled="loadingButton===pubType.id">
